...
public class TestCaseDesignServiceImpl implements TestCaseDesignService {
    ...
    @Override
    public List<TestCaseDesign> getListByMark(String caseMark) {
        return testCaseDesignMapper.getListByMark(caseMark);
    }
    ...
    @Override
    public int updateCase(TestCaseDesign testCase) {
        return testCaseDesignMapper.updateCase(testCase);
    }

    @Override
    public int checkMark(String curMark) {
        return testCaseDesignMapper.checkMark(curMark);
    }

    @Override
    public int createCase(TestCaseDesign newCase) {
        return testCaseDesignMapper.createCase(newCase);
    }
